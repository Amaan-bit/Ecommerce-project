                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="name" class="form-control @error('title') is-invalid @enderror" value="{{old('title')}}" placeholder="Title">
                                        @error('title')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label>Slug</label>
                                        <input type="text" readonly id="slug" name="slug" class="form-control" value="{{old('slug')}}" placeholder="Slug" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="short_description" id="short_description" cols="30" rows="10" class="summernote @error('short_description') is-invalid @enderror" placeholder="Short Description">{{old('short_description')}}</textarea>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="10" class="summernote @error('description') is-invalid @enderror" placeholder="Description">{{old('description')}}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="shipping_returns" id="shipping_returns" cols="30" rows="10" class="summernote @error('shipping_returns') is-invalid @enderror" placeholder="Shipping Returns">{{old('shipping_returns')}}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="compare_price" value="{{old('compare_price')}}" id="compare_price" class="form-control @error('compare_price') is-invalid @enderror" placeholder="Compare Price">
                                        @error('compare_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" min="0" name="qty" id="qty" class="form-control @error('qty') is-invalid @enderror" value="{{old('qty')}}" placeholder="Qty">	
                                        @error('qty')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
